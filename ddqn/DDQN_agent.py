...
class ReplayBuffer:
    ...
    def save_memory(self):
        ...
        with open('buffer_DDQN.json', 'w', encoding='utf-8') as f:
            json.dump(data, f, ensure_ascii=False, indent=2)

    def load_memory(self):
        with open('buffer_DDQN.json') as json_data:
...
class Agent:
    def __init__(self, lr, gamma, n_actions, epsilon, batch_size,
        ...
        self.alternate_model = build_dqn(lr, n_actions, input_dims, 128, 128)
        self.target_net.set_weights(self.q_eval.get_weights())


    def lr_update(self,lr):
        K.set_value(self.target_net.optimizer.learning_rate, lr)
    ...
    def alter_update(self):
        self.alternate_model.set_weights(self.q_eval.get_weights())
    ...
    def learn(self):
        ...
        q_alternate = self.alternate_model.predict(states_)
        q_next = self.target_net.predict(states_)[np.argmax(q_alternate,axis=1)]
    ...
    def save_weights(self, checkpoint_name):
        ...
        self.q_eval.save_weights('./checkpoints_DDQN/'+checkpoint_name)
    ...
    def save_model(self, episode):
        print('Saving Model.....')
        self.q_eval.save('./models_DDQN/' + str(episode) + self.model_file)
