...
if __name__ == '__main__':
    ...
    agent = Agent(gamma=0.99, epsilon=0.1, lr=lr, input_dims=env.observation_space.shape,
                  ...
                  epsilon_dec=0.99, epsilon_end=0.001, fname='_New_R_target.h5')
    scores = []
    eps_history = []
    dones = []
